package mr.demonid.spring.hw4.repository;

import mr.demonid.spring.hw4.config.SqlRequests;
import mr.demonid.spring.hw4.domain.User;
...
public class UserRepository implements IRepository {
    ...
    private SqlRequests sqlRequests;                // sql-запросы из файла-конфигурации

    public UserRepository(JdbcTemplate jdbc, SqlRequests sqlRequests) {
        this.jdbc = jdbc;
